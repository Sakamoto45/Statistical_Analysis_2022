...
Автоматически логарифмирую то что имеет ассиметрию  и длинный хвост справа
...
Маленькие города выросли, визуально медиана и первая квартиль увеличиись.

Применять t-test нельзя: распределения не нормальные.
Применить t-test можно: выборка не силишком маленькая (что такое маленькая?).
