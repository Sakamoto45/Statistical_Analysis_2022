...
## 5 если бы выборка была маленькая или дисперсии были неравны, пришлось бы применять непараметрический t-test Вилксона.
...
## Сравнение городов по температуре

Сначала проверим дисперсии.
```{r}
hot <- (data_logged %>%
...
Что надо было доделать: Дописать про тест фишера и что нужно делать, а что просто так.
